...
REST API service providing workspace-scoped observability features for Event Integration Platform.
...
| `AUTH_JWT_AUDIENCE`        | `event-integration-platform`        | Expected JWT audience                |
